...
public:
    ...
    void red_toggled ();
    bool red_click (GdkEventButton* event);
    void green_toggled ();
    bool green_click (GdkEventButton* event);
    void blue_toggled ();
    bool blue_click (GdkEventButton* event);
    void value_toggled ();
    bool luma_click (GdkEventButton* event);
    void chro_toggled ();
    bool chroma_click (GdkEventButton* event);
